...
class ContentController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (in_array($content->text,['Facebook','Instagram','Twitter']) ){
            ...
            $content->text_gr = $request->input('text_gr');
            ...
            $content->subheader_gr = $request->input('subheader_gr');
            ...
            $content->news_title_gr = $request->input('news_title_gr');
    ...
    public function store(Request $request)
    {
        ...
        $slider->text_gr = strip_tags($validatedData['text_gr']);
        ...
        $slider->subheader_gr = strip_tags($validatedData['subheader_gr']);
        ...
        $slider->news_title_gr = strip_tags($validatedData['news_title_gr']);
