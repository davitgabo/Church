            ...
            <div class="contact-info">
                <div>
                    ...
                    <div class="contact-info__socials">
                        <a href="{{$contents['social'][0]['uri']}}">{{$contents['social'][0]['text']}}</a>
                        <a href="{{$contents['social'][1]['uri']}}">{{$contents['social'][1]['text']}}</a>
                        <a href="{{$contents['social'][2]['uri']}}">{{$contents['social'][2]['text']}}</a>
                    </div>
                </div>
